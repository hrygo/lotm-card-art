...
边框侧铭文属于独立的设计资产，不得把普通字体直接贴到柱体上。Agentic负责研究途径专属的铭刻语法、端饰、凹槽和浮雕材质；程序以真实输入字符生成精确字形轮廓，并装配暗槽、抬升边、刻面和边缘高光。至少六字竖排容量、固定安全区、逐字回读和零几何漂移是生产门槛；生图中的伪文字只能作为风格参考，不能进入正式文字层。
