...
同一角色也可以拥有多张独立身份卡；当前客户端以隔离 fixture 展示 S00 愚者先生、S09 克莱恩、序列之上·诡秘之主的福生玄黄天尊、序列之上·星界支柱的上帝与序列之上·现实支柱的堕落母神五张卡，均已接入卡图、六维、故事与本地配音，不代表正式卡牌已经完成或获最终视觉批准。
...
### 当前能力
- 📚 **书架画廊**：M1 fixture 展示五张隔离卡（S09 克莱恩、S00 愚者先生、序列之上·诡秘之主的福生玄黄天尊、序列之上·星界支柱的上帝、序列之上·现实支柱的堕落母神），模型为动态 0…N 预留。
