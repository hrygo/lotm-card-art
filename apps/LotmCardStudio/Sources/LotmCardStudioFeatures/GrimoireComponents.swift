    ...
    public var body: some View {
        ZStack {
            ...
            Circle()
                ...
                .overlay {
                    Circle()
                        .stroke(ArchiveTheme.Brass.patina, lineWidth: 0.8)
                }
...
public struct HermeticSigilView: View {
    ...
    public var body: some View {
        ZStack {
            ...
            // 外层同心圆轮廓 (带金属微反光与下陷阴影)
            Circle()
                .stroke(ArchiveTheme.Brass.core.opacity(0.35), lineWidth: 1.5)
                .frame(width: size * 0.96, height: size * 0.96)

            Circle()
                .stroke(ArchiveTheme.Brass.patina.opacity(0.40), lineWidth: 1)
            ...
            // 中层符文圆环
            Circle()
                .stroke(ArchiveTheme.Brass.luster.opacity(0.28), style: StrokeStyle(lineWidth: 1.2, dash: [4, 6]))
                .frame(width: size * 0.74, height: size * 0.74)

            // 内接正八角星神圣几何 (八大非凡枢纽)
            ForEach(0..<2, id: \.self) { i in
                Rectangle()
                    .stroke(ArchiveTheme.Brass.core.opacity(0.20), lineWidth: 1)
            ...
            // 内层核心圆环
            Circle()
                .stroke(ArchiveTheme.Brass.core.opacity(0.30), lineWidth: 1)
