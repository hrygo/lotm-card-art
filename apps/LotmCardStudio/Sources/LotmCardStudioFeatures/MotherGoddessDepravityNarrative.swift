...
enum MotherGoddessDepravityNarrative {
    ...
    private static let storyOne = NarrativeLine(
        id: "mgd-story-01",
        kind: .story,
        text: "在最开始，她并不是缺口。她拥有完整的母巢，也拥有与之相配的两条途径；后来，最初造物主的苏醒把其中一部分从她身上撕了下来，落到了一颗名叫地球的星球上。被撕下的那部分自己长成了新的东西，甚至长出了新的意志——而她留在原处的部分，只能保持着支柱的象征，站在屏障之外。",
        sourceKind: .interpretation,
        review: .approved(contentDigest: "3262b8245ddc90f4762899c52e7a098630cd3b5bc0684a24710ff5eff372f9d2"),
        contentDigest: "3262b8245ddc90f4762899c52e7a098630cd3b5bc0684a24710ff5eff372f9d2",
    ...
    private static let storyTwo = NarrativeLine(
        id: "mgd-story-02",
        kind: .story,
        text: "她被称作母亲，也被称作邪恶之始。这两件事在她身上从来不是矛盾：给予生命，与利用生命、收回生命，是同一个动作的两面。她的力量被拆成两条路，一条通向现实与孕育，一条通向堕落与原罪——分开之后，两条路都还在替她说话。",
        sourceKind: .interpretation,
        review: .approved(contentDigest: "c9ba5434c130ee18b05720ee8cf52fc98ea8c5bf624fded6c64fc7042e6b70cb"),
        contentDigest: "c9ba5434c130ee18b05720ee8cf52fc98ea8c5bf624fded6c64fc7042e6b70cb",
    ...
    private static let storyThree = NarrativeLine(
        id: "mgd-story-03",
        kind: .story,
        text: "到最后，她也没有停下。母巢还在地球的某个侧面；只要它不被拿回，她就一直带着缺口站着。她不会死去，但也没有恢复完整——这不是失败，也不是胜利，而是一种被拉长的等待。",
        sourceKind: .interpretation,
        review: .approved(contentDigest: "9edac956182abd8dc0fafe90ec0678aed5212edfaf3c9e4b86a4f967807528da"),
        contentDigest: "9edac956182abd8dc0fafe90ec0678aed5212edfaf3c9e4b86a4f967807528da",
