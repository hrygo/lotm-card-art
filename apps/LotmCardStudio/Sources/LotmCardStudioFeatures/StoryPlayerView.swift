            ...
            .background {
                ZStack {
                    if isSelected {
                        ...
                        RoundedRectangle(cornerRadius: 8, style: .continuous)
                            .stroke(ArchiveTheme.Brass.luster.opacity(0.45), lineWidth: 1)
                    } else if isHovered {
                        RoundedRectangle(cornerRadius: 8, style: .continuous)
                            .fill(ArchiveTheme.Leather.deep.opacity(0.5))
                        RoundedRectangle(cornerRadius: 8, style: .continuous)
                            .stroke(ArchiveTheme.Borders.subtle, lineWidth: 0.8)
                    }
                }
            }
            ...
            HStack(spacing: 8) {
                ...
                if isCurrentPlaying {
                    ...
                    .background {
                        ...
                        Capsule()
                            .stroke(ArchiveTheme.Aether.light.opacity(0.4), lineWidth: 0.8)
                    }
                }
            }
